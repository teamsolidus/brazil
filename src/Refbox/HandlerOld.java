 ...
 */
public class HandlerOld extends Observable implements ProtobufMessageHandler
{
...
// ---------------------------- MachineReport ----------------------------------
    ...
    public HandlerOld(ProtobufBroadcastPeer peer) throws AWTException
    {
        this.peer = peer;
