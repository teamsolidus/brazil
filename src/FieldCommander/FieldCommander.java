...
public class FieldCommander extends Frame implements MouseListener
{
    ...
    private OtherRoboPosition[] roboPos =
    {
        new OtherRoboPosition(false, 0, 0, 0),
        new OtherRoboPosition(false, 0, 0, 0),
        new OtherRoboPosition(false, 0, 0, 0)
    };
    ...
    public OtherRoboPosition getRoboPos(int nr)
    {
        return roboPos[nr - 1];
    }
...
//</editor-fold>
        ...
        setCell(1, 8, "W1", false, NORTH);
        machineMap.put("W1", cell[1][6]);

        setCell(3, 8, "W2", false, NORTH);
        machineMap.put("W2", cell[3][8]);

        setCell(9, 8, "W3", false, NORTH);
        machineMap.put("W3", cell[3][8]);

        setCell(15, 8, "W4", false, NORTH);
        machineMap.put("W4", cell[15][8]);

        setCell(17, 8, "W5", false, NORTH);
        machineMap.put("W5", cell[17][8]);
...
// hier kann die Mittelpunktkoordianten des Panels abgefragt werden ( evtl brauchen wir noch eine Variable mehr mit dem Effektivwert )
        System.out.println(f.cell[2][0].getRealX());
        System.out.println(f.cell[2][0].getRealY());
